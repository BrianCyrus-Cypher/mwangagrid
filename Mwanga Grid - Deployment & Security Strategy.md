...
auditLog('ADMIN_CHANGE', adminId, { changedField: 'price', oldValue, newValue });
```
...
|------|------|--------|------|
| Security Lead | Brian Ngatia | ☐ Approved | _______ |
| DevOps Lead | (To be assigned) | ☐ Approved | _______ |
| Client | Mr. Daniel | ☐ Approved | _______ |

  ...
  return (
    <div className="relative min-h-screen bg-background flex flex-col lg:flex-row">
      ...
      <div className="relative w-full lg:w-1/2 lg:min-h-screen h-[40vh] lg:h-auto overflow-hidden shrink-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#060D1A] via-[#111D35]/60 to-black/20 lg:bg-gradient-to-r lg:from-transparent lg:via-[#0B1426]/30 lg:to-[#182D4A]/95" />
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8 lg:py-0 relative overflow-hidden">
        ...
        <div className="absolute inset-y-0 left-0 w-80 bg-gradient-to-r from-[#0B1426]/50 via-[#111D35]/20 to-transparent pointer-events-none lg:block hidden" />
